...
Namespace ExtendAuditEF.Win
    ...
    Public Class ExtendAuditEFWindowsFormsApplication
        ...
        Public Sub New()
            ...
            DatabaseVersionMismatch += AddressOf ExtendAuditEFWindowsFormsApplication_DatabaseVersionMismatch
            CustomizeLanguagesList += AddressOf ExtendAuditEFWindowsFormsApplication_CustomizeLanguagesList
        End Sub

        Private Sub ExtendAuditEFWindowsFormsApplication_CustomizeLanguagesList(ByVal sender As Object, ByVal e As CustomizeLanguagesListEventArgs)
        ...
        Private Sub ExtendAuditEFWindowsFormsApplication_DatabaseVersionMismatch(ByVal sender As Object, ByVal e As DatabaseVersionMismatchEventArgs)
#If EASYTEST
        e.Updater.Update();
        e.Handled = true;
#Else
