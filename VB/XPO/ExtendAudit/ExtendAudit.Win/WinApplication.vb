...
Namespace ExtendAudit.Win
    ...
    Public Class ExtendAuditWindowsFormsApplication
        ...
        Public Sub New()
            ...
            DatabaseVersionMismatch += AddressOf ExtendAuditWindowsFormsApplication_DatabaseVersionMismatch
            CustomizeLanguagesList += AddressOf ExtendAuditWindowsFormsApplication_CustomizeLanguagesList
        End Sub

        Private Sub ExtendAuditWindowsFormsApplication_CustomizeLanguagesList(ByVal sender As Object, ByVal e As CustomizeLanguagesListEventArgs)
        ...
        Private Sub ExtendAuditWindowsFormsApplication_DatabaseVersionMismatch(ByVal sender As Object, ByVal e As DatabaseVersionMismatchEventArgs)
#If EASYTEST
        e.Updater.Update();
        e.Handled = true;
#Else
