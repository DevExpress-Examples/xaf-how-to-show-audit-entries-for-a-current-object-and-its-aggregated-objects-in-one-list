...
Namespace ExtendAudit.Blazor.Server
    ...
    Public Class ExtendAuditBlazorApplication
        Inherits BlazorApplication

        Public Sub New()
            ApplicationName = "ExtendAudit"
            CheckCompatibilityType = DevExpress.ExpressApp.CheckCompatibilityType.DatabaseSchema
            DatabaseVersionMismatch += AddressOf ExtendAuditBlazorApplication_DatabaseVersionMismatch
        End Sub
...
#End If
        ...
        Private Sub ExtendAuditBlazorApplication_DatabaseVersionMismatch(ByVal sender As Object, ByVal e As DatabaseVersionMismatchEventArgs)
#If EASYTEST
        e.Updater.Update();
        e.Handled = true;
#Else
